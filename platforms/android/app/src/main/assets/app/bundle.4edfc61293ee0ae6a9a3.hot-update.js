  ...
  methods: {
    ...
    login() {
      ...
      axios.post('https://api.crabrr.com/auth/apikey', {
        username: "Administrator",
        password: "123"
      }).then(response => console.log('RESPONSE: ' + response.status)).catch(error => console.log(error)); // NOTE: test JSON Response to be received from some API Endpoint
      // var res = someAPICall()
